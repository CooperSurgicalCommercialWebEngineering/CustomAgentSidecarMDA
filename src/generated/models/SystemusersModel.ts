...
export const Systemusersmaftagsc_employmenttype = {
  100000000: 'FullTime',
  100000001: 'PartTime',
  100000002: 'Contractor',
  100000003: 'Intern'
} as const;
export type Systemusersmaftagsc_employmenttype = keyof typeof Systemusersmaftagsc_employmenttype;
...
export interface SystemusersBase {
  ...
  jobtitle?: string;
  lastname: string;
  maftagsc_employmenttype?: Systemusersmaftagsc_employmenttype;
  maftagsc_hiredate?: string;
  middlename?: string;
...
export interface Systemusers extends SystemusersBase {
  ...
  maftagsc_employmenttypename?: string;
