...
- **Styling and release resources.** Use the [interactive styling and release guide](docs/AgentSidecarStylingAndReleaseGuide.html) for machine prerequisites, safe customization, validation, Dynamics iteration, and solution promotion. The [downloadable guide bundle](docs/AgentSidecarStylingGuideBundle.zip) includes the guide and its [validated Dynamics screenshot](docs/assets/agent-sidecar-coopersurgical-theme.png) for offline sharing.
